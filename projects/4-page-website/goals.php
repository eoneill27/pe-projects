...
<h2>End of the Month</h2>
	<ul>
		...
		<li>be consistent in my visual inspiration collection habits</li>
	</ul>
...
<h2>5-year vision</h2>
	<ul>
		...
		<li>flexible schedule - able to take long vacations, or work 4-day weeks</li>
		<li>work when and where I want to</li>
