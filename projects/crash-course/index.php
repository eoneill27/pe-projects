...
<html lang="en">
	<head>
		...
		echo "<style>
					html, body *, inner-column, header, main, footer, .site-header, .site-footer, .top-footer inner-column, .bottom-footer inner-column, .heyyou-voice, .reading-voice, .vid-title-voice, .vid-meta-voice, a, li {
