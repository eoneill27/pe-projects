...
<form action="" method="post">
	...
	<div class="form-fields">
		...
		<input type="text" name="verb1" id="verb1" value="<?=$verb1?>" required>

		<label for="adjective2">Enter another adjective</label>
		<input type="text" name="adjective2" id="adjective2" value="<?=$adjective2?>" required>
		...
		<input type="text" name="adjective3" id="adjective3" value="<?=$adjective3?>" required>
		...
		<input type="text" name="adjective4" id="adjective4" value="<?=$adjective4?>" required>

		<label for="adjective5">Ok! Last adjective, I swear!</label>
		<input type="text" name="adjective5" id="adjective5" value="<?=$adjective5?>" required>

		<label for="noun3">Enter another noun</label>
		<input type="text" name="noun3" id="noun3" value="<?=$noun3?>" required>

		<label for="noun4">Almost done. One more noun.</label>
		<input type="text" name="noun4" id="noun4" value="<?=$noun4?>" required>
