...
<inner-column>
	<section class="resume">
		...
		<ul class="reading-voice">
			...
			<li><h3>Graduate Academic Assistant, Reference Desk</h3>
				September 2007-April 2008<br/>
				Woodward Biomedical Library, University of British Columbia<br/>
				Vancouver, British Columbia<br/>
			</li>
			<li><h3>Student Library Assistant</h3>
				May 2007-April 2008<br/>
				Woodward Biomedical Library, University of British Columbia<br/>
				Vancouver, British Columbia<br/>
			</li>
			<li><h3>Library Assistant</h3>
				October 2006-May 2007<br/>
				Disability Services, University of British Columbia<br/>
				Vancouver, British Columbia<br/>
			</li>
			<li><h3>Manuscripts Processing Assistant</h3>
