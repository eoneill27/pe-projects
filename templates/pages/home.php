		...
		<section class="home-grid">
			<inner-column>
				...
				<section class="home-welcome">
					...
					<?php 
						$textCopy = "<p class='reading-voice'>In my first career, I spent 15 years working as a professional librarian. In my second career, I hope to focus on helping small businesses build beautiful, functional, accessible web sites. Whether you need a site built from scratch or you have an existing site that needs a bit of TLC, I can help you achieve your goals and build your business.</p> 
