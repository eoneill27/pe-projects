	...
	<div class="page-content">
		<generic-text class="about-text">
			...
			<p class="reading-voice">Enter the mentorship program offered by <a href="https://perpetual.education" target="_blank">Perpetual Education</a>. I was thrilled to start Design for the Web in September, 2022, and I expect to finish the course in April, 2023.</p>
	...
	<div class="about-right">
		...
		<div class="about-photos">
			...
			<a class="fake-button resume-link heyyou-voice" href="?page=resume">Resume</a>
			<!-- </div> -->
		</div>
	</div>
